package org.earthcube.geosoft.shared.classes.util;
...
public class KBConstants {
  ...
  private static String liburi = "http://www.geosoft-earthcube.org/repository/software/";
//  private static String serveruri = "http://192.168.1.2:9999";
